...
int main()
{
	...
	errors[0] = { "Facebook", "Error", "12&3", 15, 9, 2010, 16, 23 };
	errors[1] = { "Paint", "Warning", "104&7b", 20, 11, 2015, 10, 11 };
	errors[2] = { "Browser Edge", "Error: closed app", "00&4Qs", 9, 4, 2017, 20, 36 };
	errors[3] = { "Telegram", "Warning", "b&56", 28, 2, 2006, 9, 24 };
	errors[4] = { "Forza Motorsport", "Warning", "Q&306", 23, 5, 2009, 18, 19 };
